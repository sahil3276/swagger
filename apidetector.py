...
if __name__ == "__main__":
    ...
    common_endpoints = [
        ...
        '/api/swagger/v2/api-docs', '/api/swagger/v3/api-docs', '/api/v1/docs', '/api/v2/docs', '/api/v3/docs', '/classicapi/doc/'
        ]
    ...
    '/v1.x/swagger-ui.html', '/swagger/swagger-ui.html', '/api/v1/docs', '/api/v2/docs', '/api/v3/docs', '/swagger/index.html'
    ]
